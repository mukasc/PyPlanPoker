    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="text-center mb-12 relative z-10">
        <div className="flex items-center justify-center gap-3 mb-4">
          <div className="w-14 h-14 bg-gradient-to-br from-primary to-primary/70 rounded-xl flex items-center justify-center shadow-lg shadow-indigo-900/30">
           ...
           {!showGuestForm ? (
             <>
               ...
               <Button 
                 ...
                 className="w-full bg-accent/50 border-border text-foreground/80 hover:text-primary-foreground hover:bg-accent h-10 rounded-full"
               >
             ...
             <form onSubmit={handleGuestLogin} className="w-full space-y-4">
                ...
                <div className="flex gap-2">
                  <Button 
                    ...
                    className="w-1/3 text-muted-foreground hover:text-primary-foreground"
                  >
                    Back
                  </Button>
                  <Button 
