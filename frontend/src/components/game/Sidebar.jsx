              ...
              return (
                ...
                >
                  ...
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold ${
                    isCurrentUser ? 'bg-primary text-white' : 'bg-muted text-foreground/90'
                  }`}>
                  ...
                  <div className="flex-shrink-0">
                    {cardsRevealed && voteValue !== null ? (
                      <span className="w-10 h-10 bg-foreground text-background text-background rounded-lg flex items-center justify-center font-bold font-mono text-lg">
                        {voteValue}
                      </span>
                    ) : voted ? (
                      ...
                      <span className="w-10 h-10 bg-secondary rounded-lg flex items-center justify-center">
                        <span className="w-2 h-2 bg-muted-foreground/20 rounded-full" />
                      </span>
                    )}
                  </div>
                </div>
            ...
            <div className="space-y-2">
              {spectators.map((user) => {
                ...
                return (
                  ...
                  >
                    <div className="w-8 h-8 rounded-full bg-muted/50 flex items-center justify-center text-xs font-medium text-muted-foreground">
                      {user.name.charAt(0).toUpperCase()}
                    </div>
