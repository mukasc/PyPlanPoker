    ...
    return (
      <div className="flex flex-col items-center justify-center text-muted-foreground gap-4">
        ...
        <div className="text-center">
          <p className="text-lg font-medium text-foreground/80">No Active Task</p>
  ...
  return (
    <div className="relative w-full max-w-4xl aspect-[16/10]">
      ...
      <div className={cn(
        ...
        {/* Inner felt */}
        <div className="absolute inset-4 bg-gradient-to-br from-accent/50 to-card/50 rounded-[2rem] border border-border/30" />
          ...
          >
            ...
            <div className={`px-3 py-1 rounded-full text-xs font-medium truncate max-w-24 ${
              isCurrentUser 
                ...
                : 'bg-accent/90 text-foreground/80'
            }`}>
              {user.name}
            </div>
          </div>
